...
IMPLEMENT_INTERFACE( FileParser, FILE_PARSER_FUNCTIONS )
...
char* GetStringValue( int fileID, const char* path )
{
...
long GetIntegerValue( int fileID, const char* path )
{
  const kson_node_t* valueNode = GetPathNode( fileID, path );
...
double GetRealValue( int fileID, const char* path )
{
  const kson_node_t* valueNode = GetPathNode( fileID, path );
...
bool GetBooleanValue( int fileID, const char* path )
{
  const kson_node_t* valueNode = GetPathNode( fileID, path );
...
size_t GetListSize( int fileID, const char* path )
{
...
bool HasKey( int fileID, const char* path )
{
