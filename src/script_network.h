...
static PyObject* addClient( PyObject*, PyObject* );
static PyObject* sendMessage( PyObject*, PyObject* );
static PyObject* receiveMessage( PyObject*, PyObject* );
static PyObject* receiveLastMessage( PyObject*, PyObject* );
static PyObject* connectionsNumber( PyObject*, PyObject* );
static PyObject* clientsNumber( PyObject*, PyObject* );
...
static PyModuleDef networkModule = {
    PyModuleDef_HEAD_INIT, "NetworkInterface", NULL, -1, networkMethods,
    NULL, NULL, NULL, NULL
};
...
PyObject* initNetworkScriptInterface(void)
{
	PyObject *module, *dictionary, *macro;

	module = PyModule_Create( &networkModule );
...
void endNetworkScriptInterface()
{
