...
static void AxisMotor_End( AxisMotor );
static void AxisMotor_Enable( AxisMotor );
static void AxisMotor_Disable( AxisMotor );
static void AxisMotor_Reset( AxisMotor );
static void AxisMotor_SetOffset( AxisMotor );
static bool AxisMotor_IsEnabled( AxisMotor );
static bool AxisMotor_HasError( AxisMotor );
...
static void AxisMotor_End( AxisMotor motor )
{
...
static void AxisMotor_Enable( AxisMotor motor )
{
  if( motor == NULL ) return;
...
static void AxisMotor_Disable( AxisMotor motor )
{
  if( motor == NULL ) return;
...
static void AxisMotor_Reset( AxisMotor motor )
{
  if( motor == NULL ) return;
...
static bool AxisMotor_IsEnabled( AxisMotor motor )
{
...
static bool AxisMotor_HasError( AxisMotor motor )
{
  if( motor == NULL ) return false;
...
static void AxisMotor_WriteControl( AxisMotor motor, double setpoint )
{
  ...
  motor->interface->WriteSetpoints( motor->axisID, rawSetpointsList );
}
