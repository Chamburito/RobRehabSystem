...
#ifndef _PCI4EHELPER_H_
#define _PCI4EHELPER_H_
...
extern "C"{ 
	...
	int PCI4E_GetCaptureEnabled(short iDeviceNo, short iEncoder, int *pbVal);
	int PCI4E_GetControlMode(short iDeviceNo, short iEncoder, long *plMode);
	int PCI4E_GetCount(short iDeviceNo, short iEncoder, long *plVal);
	int PCI4E_GetCounterMode(short iDeviceNo, short iEncoder, short *piMode);
	int PCI4E_GetEnableAccumulator(short iDeviceNo, short iEncoder, int *pbVal);
	int PCI4E_GetEnableIndex(short iDeviceNo, short iEncoder, int *pbVal);
	int PCI4E_GetForward(short iDeviceNo, short iEncoder, int *pbVal);
	int PCI4E_GetInvertIndex(short iDeviceNo, short iEncoder, int *pbVal);
	int PCI4E_GetMatch(short iDeviceNo, short iEncoder, long *plVal);
	int PCI4E_GetMultiplier(short iDeviceNo, short iEncoder, short *piMode);
	int PCI4E_GetPresetOnIndex(short iDeviceNo, short iEncoder, int *pbVal);
	int PCI4E_GetPresetValue(short iDeviceNo, short iEncoder, long *plVal);
	int PCI4E_GetROM_ID(short iDeviceNo, short *piROM_ID);
	int PCI4E_GetSlotNumber(short iDeviceNo, short *piSlotNo);
	int PCI4E_GetStatus(short iDeviceNo, short iEncoder, long *plVal);
	int PCI4E_GetTimeStamp(short iDeviceNo, long *plVal);
	int PCI4E_GetTriggerOnIncrease(short iDeviceNo, short iEncoder, int *pbVal);
	int PCI4E_GetTriggerOnIndex(short iDeviceNo, short iEncoder, int *pbVal);
	int PCI4E_GetTriggerOnMatch(short iDeviceNo, short iEncoder, int *pbVal);
	int PCI4E_GetTriggerOnDecrease(short iDeviceNo, short iEncoder, int *pbVal);
	int PCI4E_GetTriggerOnRollover(short iDeviceNo, short iEncoder, int *pbVal);
	int PCI4E_GetTriggerOnRollunder(short iDeviceNo, short iEncoder, int *pbVal);
	int PCI4E_GetTriggerOnZero(short iDeviceNo, short iEncoder, int *pbVal);
	int PCI4E_GetVersion(short iDeviceNo, short *piVersion);
	...
	int PCI4E_ReadTimeStamp(short iDeviceNo, long *plTimeStamp);
	...
	int PCI4E_SetControlMode(short iDeviceNo, short iEncoder, long lMode);
	...
	int PCI4E_ReceiveData(short iDeviceNo, short *piSize, unsigned char *piData);
