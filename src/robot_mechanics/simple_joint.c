...
void End( int robotID )
{
  
}

size_t GetDoFsNumber( int robotID )
{
  return DOFS_NUMBER;
}

void GetForwardKinematics( int robotID, double** jointValuesTable, double* dofValuesList, size_t dofIndex )
{
...
void GetInverseKinematics( int robotID, double** dofValuesTable, double* jointValuesList, size_t jointIndex )
{
...
void GetForwardDynamics( int robotID, double** jointValuesTable, double* dofValuesList, size_t dofIndex )
{
...
void GetInverseDynamics( int robotID, double** dofValuesTable, double* jointValuesList, size_t jointIndex )
{
