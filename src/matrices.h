...
void Matrices_Discard( Matrix );                                      // Desaloca memória de matrix fornecida
double Matrices_GetElement( Matrix, size_t, size_t );                 // Obtém elemento da matriz na linha e coluna dadas
double* Matrices_GetAsVector( Matrix );                               // Obtém vetor de 1 dimensão dos elementos da matriz
...
/*#define MATRICES_FUNCTIONS( namespace, function_init ) \
        ...
        function_init( double, namespace, GetElement, Matrix, size_t, size_t ) \          // Obtém elemento da matriz na linha e coluna dadas
